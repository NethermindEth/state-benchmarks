...
#   MOCK_CL_JWT        Secret path or 0x-hex. Defaults to GETH_JWT_PATH, falling back to
#                      the repo-tracked docker/jwtsecret (the same file the compose mounts
#                      into the geth container at /jwt).
...
DEFAULT_JWT="${GETH_JWT_PATH:-docker/jwtsecret}"
